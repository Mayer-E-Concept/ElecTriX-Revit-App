...
namespace METools
{
    ...
    public class App : IExternalApplication
    {
        ...
        {
            string tab="Werkzeuge";
            try{app.CreateRibbonTab(tab);}catch{}
            var panel=app.CreateRibbonPanel(tab,"Objekte");
            string path=System.Reflection.Assembly.GetExecutingAssembly().Location;
            panel.AddItem(new PushButtonData("SymDist","Symmetrisch\nVerteilen",path,"SymmetricDistributor.DistributeCommand")
                { ToolTip="Objekte symmetrisch verteilen. Zuerst ein Objekt auswählen." });
            return Result.Succeeded;
        }
